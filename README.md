...
[![Verify](https://img.shields.io/badge/verify-185%2F185%20passing-brightgreen.svg)](#verify-it-yourself)
...
**Published:** [https://doi.org/10.5281/zenodo.21430784](https://doi.org/10.5281/zenodo.21430784) · **Author ORCID:** [https://orcid.org/0009-0007-2454-5573](https://orcid.org/0009-0007-2454-5573) · **Version:** 2.2.9
...
> **Corpus state:** 195 registered claims (92 Derived, 84 Modeled, 4 EFT-constrained, 3 Conjecture, 5 Open, 7 Failed-and-kept); 185 code-backed, all passing; 58 papers. Counts regenerate from `claims.yaml` — the authority is the registry, not this line.
