...
[![Verify](https://img.shields.io/badge/verify-190%2F190%20passing-brightgreen.svg)](#verify-it-yourself)
...
**Published:** [https://doi.org/10.5281/zenodo.21430784](https://doi.org/10.5281/zenodo.21430784) · **Author ORCID:** [https://orcid.org/0009-0007-2454-5573](https://orcid.org/0009-0007-2454-5573) · **Version:** 2.3.0
...
> **Corpus state:** 200 registered claims (94 Derived, 87 Modeled, 4 EFT-constrained, 3 Conjecture, 5 Open, 7 Failed-and-kept); 190 code-backed, all passing; 58 papers. Counts regenerate from `claims.yaml` — the authority is the registry, not this line.
