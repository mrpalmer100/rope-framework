...
**Published:** [https://doi.org/10.5281/zenodo.21430784](https://doi.org/10.5281/zenodo.21430784) · **Author ORCID:** [https://orcid.org/0009-0007-2454-5573](https://orcid.org/0009-0007-2454-5573) · **Version:** 3.11.0
...
>
> **What makes it unusual is the discipline.** Every claim is registered with a pass/fail line drawn *before* the computation runs, and the failures are kept on permanent display rather than quietly dropped. As of this release: **518 registered claims, 497 backed by code you can run yourself, 111 proved from the stated assumptions (Derived), and 25 failures kept in the open.** A dealbreaker, if one exists, should be findable in about five minutes — start with [`KNOWN_LIMITATIONS.md`](KNOWN_LIMITATIONS.md).
>
...
>
> **Where the story ends is stated as precisely as where it succeeds** — because a framework earns trust at its edges. On entanglement the framework does more than most expect — it *derives* the exact ceiling on quantum correlations (the Tsirelson bound) as a theorem and demonstrates a Bell violation end to end — but it proves that no counting model of ropes-in-space can produce those correlations on its own (kept as QB-003), so the honest route across that wall adds one guiding influence it does not yet derive from the ropes. It says so plainly rather than blurring the seam. The split-quantum "funneling step" behind beamsplitter statistics is a *measured* boundary of the classical detector, now bridged by the third grant — indivisible delivery — adopted openly with its falsifiers armed, while its deeper mechanism stays a named open problem. Each edge carries its own falsifier. That is the point: this is a framework built to be *wrong in specific ways*, which is what makes it physics rather than story.

> **Corpus state:** 518 registered claims (111 Derived, 369 Modeled, 4 EFT-constrained, 4 Conjecture, 5 Open, 25 Failed-and-kept); 497 code-backed, all passing; 59 papers. Counts regenerate from `claims.yaml` — the authority is the registry, not this line.
