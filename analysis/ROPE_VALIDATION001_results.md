...
max exact-lattice spectral error=1.18394e-11  
max gauge-transformation spectral error=1.69049e-11  
max link-vs-twist spectral error=1.07283e-11  
max alpha->alpha+1 periodicity error=1.29727e-11  
max alpha->-alpha reversal error=0  
finest first-8 continuum error=0.00571076  
ground-state half-flux response=0.249999  
period closure error=4.07563e-12  
B1_hermitian: PASS  
