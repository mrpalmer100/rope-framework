...
> ROPE| A current is the two-strand helix being turned like a screw. Rotate it at the battery and, because a helix IS a screw (corkscrew, Archimedes screw), the turning drives the load at the far end — one motion, one object. The instant-on puzzle dissolves: turning a shaft transmits promptly, like a speedometer cable, with no separate field invoked.
> EQUATIONS| the SAME conserved current and continuity, reproduced. The screw is verified to pump exactly one unit of charge per turn and to deliver power as torque × turning-rate, mirroring power = voltage × current — the same electrical laws, realized as a literal mechanical screw rather than an abstract carrier-drift-plus-field.
...
> CALLOUT|WHAT CURRENT IS — THE HELIX IS A SCREW
...
![A current is the two-strand helix turned like a screw: rotate it at the battery and, because a helix is a screw (corkscrew, Archimedes screw), the turning drives the load at the far end. Rotation and transport are one motion; the material stays put.](fig:stream)
...
> CALLOUT|ONE INSIGHT, THREE FAMILIAR RULES
