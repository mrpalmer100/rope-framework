...
- **The absolute atomic scale is BLOCKED** on two declared missing inputs (FND-MATTER-003).
...
- **EM-011**: Cosmological alpha-variation test FALSIFIES the strong (local density-tracking) form of the rope-density hypothesis for the EM cou
- **GRV-009**: FAILED CANDIDATE
- **GRV-010**: FAILED
