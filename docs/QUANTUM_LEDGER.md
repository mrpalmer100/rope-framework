...
**246 claims touch quantum vocabulary; only 11 genuinely depend on a quantum
...
Everything else that says "quantum" is: a **fence** (19 claims that stop at the
...
chain, where hbar only converts units), or **incidental** (172).
