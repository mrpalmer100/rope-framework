# Where the Programme Stands -- the Full Account

*The complete prose the front-door README summarizes: where the framework is
strong, where the edges are, and the committed-bets ledger in full. Current as
of the release stated in the README banner; the authority is always
`claims.yaml`.*
